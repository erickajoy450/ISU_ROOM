...
function handleLogin(event) {
    ...
    if (matchingUser) {
        ...
        // Load existing schedules after login
        loadSchedules();
    } else {
...
function submitSchedule(event) {
    ...
    // Check if the room is already reserved for the same day and time
    const roomOccupied = schedules.some(schedule => schedule.room === room && schedule.day === day && schedule.timeIn === timeIn && schedule.timeOut === timeOut);
